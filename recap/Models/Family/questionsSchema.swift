...
// MARK: - Question Subcategories (Expanded)
enum QuestionSubcategory: String, Codable {
    ...
    case familyAdded
    case nutrition // New
    case fitnessExercise // New
    case socialInteraction // New
    case moodEmotion // New
    case personalHygiene // New
    case medicationManagement // New
    case cognitiveExercises // New
    case outdoorActivities // New
}

// MARK: - Question Types (Expanded)
...
struct Question: Identifiable, Codable {
    ...
    var answers: [String]
    var correctAnswers: [String]? // Supports multiple correct answers
    var image: String?
    var isAnswered: Bool
    ...
    var hint: String?
    var confidence: Int? // Tracks confidence level (1-10)
    var hardness: Int // Difficulty level (1-5)
...
// MARK: - Daily Questions View Controller
