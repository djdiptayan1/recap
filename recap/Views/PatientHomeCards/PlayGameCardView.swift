...
class PlayGameCardView: UIView {
    ...
    private func setupUI() {
        ...
        // Icon Image
        iconImageView.image = UIImage(named: "Game")
        iconImageView.contentMode = .scaleAspectFit
        iconImageView.translatesAutoresizingMaskIntoConstraints = false
        addSubview(iconImageView)
        
        // Title Label
        titleLabel.text = "Play a Game"
        ...
        // Description Label
        descriptionLabel.text = "Helps you to reduce memory decline by 32%."
