...
class DeleteAccountViewController: UIViewController {
    ...
    private let descriptionLabel: UILabel = {
        let label = UILabel()
        label.text =
            "Deleting your account will permanently remove all of your data, including your profile information, memory check history, and linked family members. This action cannot be undone."
    ...
    private func initiateAccountDeletion() {
        ...
        AccountDeletionManager.shared.deletePatientAccount { [weak self] success, error in
    ...
    private func showDeletionSuccessAlert() {
        let alertController = UIAlertController(
            ...
            message: "Your account has been successfully deleted. Thank you for using our app.",
            preferredStyle: .alert
        )
