...
//            cardView.bottomAnchor.constraint(equalTo: nextButton.safeAreaLayoutGuide.topAnchor, constant: -30),
//            
//            // Title and Subtitle
//            titleLabel.topAnchor.constraint(equalTo: cardView.safeAreaLayoutGuide.topAnchor, constant: 24),
...
//            
//            // Input Fields
//            nameField.topAnchor.constraint(equalTo: fieldContainer.safeAreaLayoutGuide.topAnchor),
...
//            profileImageContainer.topAnchor.constraint(equalTo: fieldContainer.safeAreaLayoutGuide.topAnchor, constant: 20),
...
//            
//            // Profile Image
//            profileImageView.topAnchor.constraint(equalTo: profileImageContainer.safeAreaLayoutGuide.topAnchor),
...
class FamilyRegistrationViewController: UIViewController {
    ...
    let phoneField: UITextField = {
        let field = createTextField(placeholder: "Phone number", iconName: "phone", keyboardType: .numberPad)
        field.addTarget(self, action: #selector(phoneFieldDidChange(_:)), for: .editingChanged)
        return field
    }()
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            // Profile Image Container
            profileImageContainer.topAnchor.constraint(equalTo: relationField.bottomAnchor, constant: 16),
            profileImageContainer.leadingAnchor.constraint(equalTo: fieldContainer.leadingAnchor),
            profileImageContainer.trailingAnchor.constraint(equalTo: fieldContainer.trailingAnchor),
            profileImageContainer.heightAnchor.constraint(equalToConstant: 150),
            
            // Profile Image
            profileImageView.centerXAnchor.constraint(equalTo: profileImageContainer.centerXAnchor),
            profileImageView.topAnchor.constraint(equalTo: profileImageContainer.topAnchor, constant: 15),
            profileImageView.widthAnchor.constraint(equalToConstant: 120),
            profileImageView.heightAnchor.constraint(equalToConstant: 120),
    ...
    @objc private func nextTapped() {
        ...
        case 0:
            ...
            animateToNextStep()
        case 1:
            guard let phone = phoneField.text, !phone.isEmpty, isValidPhoneNumber(phone) else {
                showErrorAnimation(for: phoneField)
                return
            }
            animateToNextStep()
        ...
        case 3:
            guard selectedImage != nil else {
                showErrorAnimation(for: profileImageContainer)
                return
            }
            submitRegistration()
        default:
